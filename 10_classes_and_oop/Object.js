...
// Here new keyword is very important 
const chai = new createUser("chai", 25)
const tea = new createUser("tea", 250)

chai.printMe()

/*  Here's what happens behind the scenes when the 
new keyword is used:

A new keyword is created : The new Keywords initiates the 
...
called with the specified arguments and this is bound to the newly
